  ...
  <!-- contente -->
         <div class="container-fluid">
              <div class="row">
                      ...
                      <!-- Remove 'active' class, this is just to show in Codepen thumbnail -->
                          <div class="select-menu  active">
                              <div class="select-btn">
                                <span class="fw-bold">{{ $brands->name_ar }}</span>
                ...
                <div class="col-lg-9 mt-4">
                          <div class="back-gift-product" style="background-image:url({{ asset('img/brands/'.$brands->logo) }})">
                            <div class="title-order pt-5 pe-5">
                            </div>
                        </div>
                            <div class="over1 mt-4">
                                ...
                                {{--  <div class="col-xxl-3 col-xl-4 col-md-4 col-sm-6">
                                  <div class="product-swiper">
                                    <span class="p-2">وفر 15 ج</span>
                                    <div class="product-image">
                                      <img src="img/product-3-1.png" alt="">
                                    </div>
                                    <p>لبن</p>
      ...
      <div class="container-fluid p-5 ">
          <div class="row">
              ...
              <div class="swiper mySwiper" style="    height: 450px !important;">
