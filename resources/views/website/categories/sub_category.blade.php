                    ...
                    <!-- Remove 'active' class, this is just to show in Codepen thumbnail -->
                        <div class="select-menu  active">
                            <div class="select-btn">
                              <span class="fw-bold">{{ $sub_categorys->name_ar }}</span>
                              <i class="fa-solid fa-chevron-down"></i>
                            </div>
                        <div class="options p-3">
                        @foreach ($sub_categorys->subsubCategory as $item )
             ...
             <div class="col-lg-9 mt-4">
                          ...
                          <div class=" mt-4">
                            <div class="d-flex justify-content-between ">
                                    <p class="fs-5 fw-bold mt-1"> {{ $sub_categorys->name_ar }}</p>
                    ...
                    @if ($sub_categorys->product->isEmpty())
                      ...
                      @else
                        <div class="over1">
                                <div class="row">
                                @foreach ($sub_categorys->product as $item )
