                    ...
                    <!-- Remove 'active' class, this is just to show in Codepen thumbnail -->
                        <div class="select-menu  active">
                            <div class="select-btn">
                              <span class="fw-bold">{{ $sub_sub_category->name_ar }}</span>
                            </div>
                        </div>
                  </div>
             ...
             <div class="col-lg-9 mt-4">
                          ...
                          <div class=" mt-4">
                            <div class="d-flex justify-content-between ">
                                    <p class="fs-5 fw-bold mt-1"> {{ $sub_sub_category->name_ar }}</p>
                    ...
                    @if ($sub_sub_category->product->isEmpty())
                      ...
                      @else
                        <div class="over1">
                                <div class="row">
                                @foreach ($sub_sub_category->product as $item )
