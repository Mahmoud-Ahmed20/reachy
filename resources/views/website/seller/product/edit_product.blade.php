            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-9 pt-3 div-boxshadow">
                    <div class="p-4">
                        ...
                        <form id="myforminput" method="POST" action="{{ route('seller.product.update' , $product->id) }}"
                            ...
                            <div class="row">
                                <div class="col-lg-3 text-center pt-5">
                                    ...
                                    <div class="avatar-update-container">
                                        <div class="picture">
                                            <img src="{{ URL::asset('img/products/' . $product->cover_image	) }}"
                                ...
                                <div class="col-lg-9 pt-3">
                                  <div class="row">
                                    ...
                                    placeholder=" اسم المنتج بالعربى" autofocus
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        placeholder=" اسم المنتج بالانجليزيه" value="{{$product->name_en}}">
                                        @error('name_en')
                                            <span class="error-msg-form">
                                                {{ $message }}
                                            </span>
                                  ...
                                  <div class="row">
                                    <div class="col-lg-6 ">
                                        ...
                                        spellcheck="false">{{ old('description_ar') }} {{$product->description_ar}}</textarea>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <textarea name="description_en" class="form-control" placeholder="وصف المنتج بالانجليزى" rows="4"
                                            spellcheck="false">{{ old('description_en') }} {{$product->description_en}}</textarea>
                                  ...
                                  <div class="row">
                                    <div class="col-lg-4  mt-2">
                                      ...
                                      name="main_categorys_id" required>القسم الرئيسى
                                        {{-- @foreach ($product as $item) --}}
                                            <option value="{{ $product->main_category->id }}">{{ $product->main_category->name_en }}</option>
                                        {{-- @endforeach --}}
                                        </select>
                                    ...
                                    <div class="col-lg-4  mt-2">
                                        ...
                                        <select class="js-example-basic-single select2-no-search select2-hidden-accessible"
                                            ...
                                            {{-- @foreach ($product as $item) --}}
                                                <option value="{{ $product->sub_category->id }}">{{ $product->sub_category->name_en }}</option>
                                            {{-- @endforeach --}}
                                        </select>
                                    ...
                                    <div class="col-lg-4  mt-2">
                                        ...
                                        <select class="js-example-basic-single select2-no-search select2-hidden-accessible"
                                            ...
                                            {{-- @foreach ($product as $item) --}}
                                                <option value="{{ $product->sub_sub_category->id }}">{{ $product->sub_sub_category->name_en }}</option>
                                            {{-- @endforeach --}}
                                        </select>
                              ...
                              <div class="row">
                                <div class="col-lg-6 mt-2">
                                    <label class="form-label"> Slug Arabic <small>(required)</small></label>
                                      ...
                                      placeholder="Url Arabic" value="{{$product->slug_ar}}" >
                                ...
                                <div class="col-lg-6 mt-2">
                                    <label class="form-label"> Slug English <small>(required)</small></label>
                                      ...
                                      placeholder="Url English" value="{{$product->slug_en}}" >
                              ...
                              <div class="row">
                                <div class="col-lg-6  mt-2">
                                    ...
                                    <select class="js-example-basic-single select2-no-search select2-hidden-accessible"
                                        ...
                                        {{-- @foreach ($Brands as $Brand) --}}
                                            <option value="{{ $product->Brand->id }}">{{ $product->Brand->name_en }}</option>
                                        {{-- @endforeach --}}
                                    </select>
                                ...
                                <div class="col-lg-6 mt-2">
                                    ...
                                    placeholder="السعر الاساسى"placeholder="Write the Orginal Price here.." value="{{$product->orginal_price}}">
                                    @error('orginal_price')
                                        <span class="error-msg-form">
                                            {{ $message }}
                                        </span>
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-12 col-md-6 mb-2">
                                      <label class="form-label"> {{ $item->subscription->name_en }}  ( Price ) <small>(required)</small></label>
                                      <input name="price[]" type="text"
                                          class="form-control @error('price') is-invalid @enderror"
                                          placeholder="Write the price here.." value="{{$item->price}}">
                                      @error('price')
                                          <span class="error-msg-form">
                                              {{ $message }}
                                          </span>
                              ...
                              <div class="row">
                                <div class="col text-center">
                                    <button type="submit" class="w-25 p-2 m-4 btn-form">تعديل</button>
                                </div>
                              </div>
                        </form>
                    </div>
