                                ...
                                <div class="row text-center">
                                    ...
                                    @endif
                                       ...
                                       <h5 class="state"><span>{{$msg}} </span></h5>
                                        ...
                                        {{--  @if ($item->status == 0)
                                            <h5 class="state"><span>منتظر</span></h5>
                                        @elseif ($item->status == 1)
                                            <h5 class="state"><span>في المحطة</span></h5>
                                        @elseif ($item->status == 2)
                                            <h5 class="state"><span>في الطريق</span></h5>
                                        @elseif ($item->status == 3)
                                            <h5 class="state"><span> تم التسليم</span></h5>
                                        @elseif ($item->status == 4)
                                            <h5 class="state"><span class="cancel">تم الغاء الطلب</span></h5>
                                        @endif  --}}
                                    </div>
                                    <div class="col-3">
