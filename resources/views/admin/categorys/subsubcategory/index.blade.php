...
@section('title-topbar', 'Sub Sub Category')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">Sub Sub Category</a>
            </span>
            ...
            <div class="d-flex justify-content-center">
                ...
                <a href="{{ route('sett.subsubCategory.create') }}"
                    class=" main-color-bg text-white btn btn-sm shadow-sm b-r-l-cont p-2 px-4 me-1"><i
                        class="fas fa-plus fa-sm me-1"></i> New Sub Sub Category</a>
            </div>
        </div>
        ...
        <div class="card shadow mb-3 pb-2">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-globe-europe"></i> All Sub Sub Categorys</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
                    ...
                    <table class="table display datatable-modal" id="p-lab-table" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-xxs">NAME Main Category</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($subsubcategory as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('sett.subsubCategory.edit', $item->id) }}"
                                        ...
                                        <a class="btn btn-sm modal-effect status-col-link cancel-color-btn b-r-xs mb-1 delete-conf"
                                            ...
                                            data-subsubcategory_id="{{ $item->id }}"
                                            ...
                                            <div class="modal-content b-r-s-cont border-0">
                                                ...
                                                <div class="modal-header">
                                                    <div class="modal-title" id="exampleModalLabel"><i
                                                        ...
                                                        Sub Sub Category delete</div>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>

                                                <form action="{{ route('sett.subsubCategory.destroy', $item->id) }}"
                                                    method="post">
                                                    {{ method_field('delete') }}
                                                    {{ csrf_field() }}
                           ...
                           {{ $subsubcategory->links('pagination::bootstrap-5') }}
                </div>
            </div>
...
@section('js')
    ...
    <script>
        $('.delete-conf').click(function(event) {
            ...
            var modal = $('.delete-conf-input [name="subsubcategory_id"]')
            modal.val(subsubcategory_id);
            $('#name_ar').val(name_ar);
        })
    </script>
