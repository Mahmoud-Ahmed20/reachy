...
@section('title-topbar', 'Edit Sub Category')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">Edit Sub Category</a>
            </span>
        </div>
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-pencil-alt"></i> Edit Sub Category</h6>
            </div>

            <!-- Card Body -->
            <div class="card-body px-3">

                <form id="myforminput" method="POST" action="{{ route('sett.subCategory.update', $subCategory->id) }}">
                    {{ method_field('PUT') }}
                    @csrf
                    ...
                    <div class="row mb-2 ">
                        ...
                        <div class="col-12 col-md-12 mb-2">
                            ...
                            <select class="js-example-basic-single select2-no-search select2-hidden-accessible"
                                ...
                                @foreach ($mainCategorys as $item)
                                    <option @if ($subCategory->mainCategory->id == $item->id) selected @endif value="{{ $item->id }}">
                                        {{ $item->name_ar }}</option>
                                @endforeach
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            ...
                            <input name="slug_ar" type="text" class="form-control @error('slug_ar') is-invalid @enderror"
                                placeholder="Write the given Countrie name english  here.."
                                value="{{ $subCategory->slug_ar }}" required>
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            ...
                            <input name="slug_en" type="text" class="form-control @error('slug_en') is-invalid @enderror"
                                placeholder="Write the given Countrie name english  here.."
                                value="{{ $subCategory->slug_en }}" required>
