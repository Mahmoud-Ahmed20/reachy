    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">Main Category</a>
            </span>
            ...
            <div class="d-flex justify-content-center">
                ...
                <a href="{{ route('sett.mainCategory.create') }}"
                    class=" main-color-bg text-white btn btn-sm shadow-sm b-r-l-cont p-2 px-4 me-1"><i
                        class="fas fa-plus fa-sm me-1"></i> New Main Category</a>
            </div>
        </div>
        ...
        <div class="card shadow mb-3 pb-2">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-globe-europe"></i> All Main Category</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
                <div class="table-responsive">
                            ...
                            @foreach ($mainCategory as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('sett.mainCategory.edit', $item->id) }}"
                                        ...
                                        <a class="btn btn-sm modal-effect status-col-link cancel-color-btn b-r-xs mb-1 delete-conf"
                                            ...
                                            data-maincategory_id="{{ $item->id }}" data-name_ar="{{ $item->name_ar }}"
                                            ...
                                            <div class="modal-content b-r-s-cont border-0">
                                                ...
                                                <div class="modal-header">
                                                    <div class="modal-title" id="exampleModalLabel"><i
                                                        ...
                                                        Main Category delete</div>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>

                                                <form action="{{ route('sett.mainCategory.destroy', $item->id) }}"
                                                    method="post">
                                                    {{ method_field('delete') }}
                                                    {{ csrf_field() }}
                                                    ...
                                                    <div class="modal-body px-4">
                                                        ...
                                                        <div class="modal-body delete-conf-input text-center py-0">
                                                            <p class="mb-0">ِAre you sure you want to delete
                                                                this
                                                                main category?</p><br>
                                                            <input type="hidden" name="maincategory_id"
                                                                value="{{ $item->id }}">
                                                        </div>
                                                    </div>
                    ...
                    {{ $mainCategory->links('pagination::bootstrap-5') }}
                </div>
            </div>
...
@section('js')
    ...
    <script>
        $('.delete-conf').click(function(event) {
            var maincategory_id = $(this).data("maincategory_id");
            var name_ar = $(this).data("name_ar");
            console.log(maincategory_id);
            var modal = $('.delete-conf-input [name="maincategory_id"]')
            modal.val(maincategory_id);
            $('#name_ar').val(name_ar);
        })
    </script>
