...
@section('title', 'Stations | Proxima - Medical Management app')

@section('title-topbar', 'Stations')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">Stations</a>
            </span>
        ...
        <div class="card shadow mb-3 pb-2">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-globe-europe"></i> All Stations</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
                            ...
                            @foreach ($station as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('sett.stations.edit', $item->id) }}"
                                    ...
                                    <div class="modal fade" id="delete1" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable ">
                                            <div class="modal-content b-r-s-cont border-0">
                                                ...
                                                <form action="{{ route('sett.stations.destroy', $item->id) }}"
                                                    method="post">
                                                    {{ method_field('delete') }}
                                                    {{ csrf_field() }}
