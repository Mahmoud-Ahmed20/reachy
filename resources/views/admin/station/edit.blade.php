...
@section('title', 'Edit station | Proxima - Medical Management app')

@section('title-topbar', 'Edit station')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-pencil-alt"></i> Edit station</h6>
            </div>

            <!-- Card Body -->
            <div class="card-body px-3">

                <form id="myforminput" method="POST" action="{{ route('sett.stations.update', $station->id) }}">
                    {{ method_field('PUT') }}
                    ...
                    <div class="row mb-2 ">
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            ...
                            <input name="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                placeholder="Write the station name here.." value="{{ $station->name }}" required>
                        </div>
                        <div class="col-12 col-md-6 mb-2">
                            <label class="form-label">Address <small>(required)</small></label>
                            <textarea name="address" class="form-control" placeholder="Write address here .." rows="4" spellcheck="false">{{ $station->address }}</textarea>
