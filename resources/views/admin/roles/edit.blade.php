...
@section('title', 'Edit Role | Proxima - Medical Management app')

@section('title-topbar', 'Edit Role')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-body px-3">
                ...
                <form id="myforminput" method="POST" action="{{ route('sett.role.update', $role->id) }}">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            ...
                            <input name="rolename" type="text" class="form-control @error('rolename') is-invalid @enderror"
                                placeholder="Write the given role here.." value="{{ $role->name }}" required>
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            ...
                            <select id="multiselect" class="js-example-basic-single form-control" multiple=""
                                ...
                                @foreach ($permissions as $iteam)
                                    <option value="{{ $iteam->id }}" @if (in_array($iteam->id, $rolePermissions)) selected @endif>{{ $iteam->name }}
                                    </option>
                                @endforeach
                    ...
                    <div class="d-flex pt-4 justify-content-center">
                        <button type="submit" class="btn btn-default btn-primary">Update Now
                        </button>
                    </div>
