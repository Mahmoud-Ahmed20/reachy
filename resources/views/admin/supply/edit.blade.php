...
@section('title', 'Edit  Supply  | Proxima - Medical Management app')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">Edit Supply</a>
            </span>
        </div>
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-pencil-alt"></i> Edit Supply</h6>
            </div>

            <!-- Card Body -->
            <div class="card-body px-3">

                <form id="myforminput" method="POST" action="{{ route('sett.supply.update',$supply->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-2 ">
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            ...
                            <input name="quantity" type="number" class="form-control @error('quantity') is-invalid @enderror"
                                placeholder="Write the given City name english  here.." value="{{ $supply->quantity}}">
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            ...
                            <select
                                ...
                                name="product_id"  value="{{ $supply->name_en}}">
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            ...
                            <select
                                ...
                                name="seller_id" required value="{{ $supply->first_name . ' ' . $supply->second_name }}">
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            ...
                            <select
                                ...
                                name="seller_stock_id" value="{{ $supply->name }}">
