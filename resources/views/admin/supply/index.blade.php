...
@section('title', 'Supply | Proxima - Medical Management app')

@section('title-topbar', 'Supply')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">Supply</a>
            </span>
        ...
        <div class="card shadow mb-3 pb-2">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-users me-2"></i> All Supply</h6>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table display datatable-modal" id="p-lab-table" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th class="text-xxs">Quantity</th>
                                <th class="text-xxs">Product</th>
                                <th class="text-xxs">Seller</th>
                                <th class="text-xxs">Seller Stock</th>
                        ...
                        <tbody>
                            @foreach ($supply as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->seller_stock_id }}</td>


                                    <td class="text-center">
                                        <a href="{{route('sett.supply.edit' ,$item->id)}}"
                                    ...
                                    <div class="modal fade" id="delete1" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable ">
                                            <div class="modal-content b-r-s-cont border-0">
                                                ...
                                                <form action="{{ route('sett.supply.destroy', $item->id) }}" method="post">
                                                      {{ method_field('delete') }}
                                                      {{ csrf_field() }}
