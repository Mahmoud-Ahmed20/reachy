    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">Edit Your profile</a> --}}
            </span>
        </div>
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-user-edit me-2"></i> Edit your
                    Profile
                </h6>
            </div>
            ...
            <div class="card-body px-3">
                ...
                <div class="multi-setps-form-calander col-12">
                    ...
                    <form id="myform" method="POST" action="{{ route('sett.edit_profile_user_store') }}"
                                    ...
                                    <select
                                        ...
                                        @foreach ($countries as $iteam)
                                            <option value="{{ $iteam->id }}"
                                                @if ($user->country->id == $iteam->id) selected @endif>
                        ...
                        <div class="cont_tap" id="about">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-12 mb-2">
                                    <label class="form-label">Started work <small>(required)</small></label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text"><i class="bi bi-calendar2-week-fill"></i> </div>
                                        </div>
