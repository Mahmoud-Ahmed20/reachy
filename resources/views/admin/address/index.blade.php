...
@section('title', 'Region | Proxima - Medical Management app')

@section('title-topbar', 'Region')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">Region</a>
            </span>
        ...
        <div class="card shadow mb-3 pb-2">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-globe-europe"></i> All Regions</h6>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table display datatable-modal" id="p-lab-table" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th class="text-xxs">Favorite Addres</th>
                                <th class="text-xxs">Name Street</th>
                                <th class="text-xxs">Address Details</th>
                                <th class="text-xxs">Building Name Or Number</th>
                                <th class="text-xxs">Phone</th>
                                <th class="text-xxs">Apartment Number</th>


                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($create_address as $item)
                                <tr>
                                    <td>{{ $item->favorite_address }}</td>
                                    <td>{{ $item->name_street }}</td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{route('sett.edit_address' ,$item->id)}}"
                                            ...
                                            <a class="btn btn-sm modal-effect status-col-link cancel-color-btn b-r-xs mb-1 delete-conf"
                                                title="delete" data-effect="effect-scale" data-role_id="{{ $item->id }}"
                                    ...
                                    <div class="modal fade" id="delete1" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable ">
                                            <div class="modal-content b-r-s-cont border-0">
                                                ...
                                                <form action="{{ route('sett.destroy_address', $item->id) }}" method="post">
                                                      {{ method_field('delete') }}
                                                      {{ csrf_field() }}
