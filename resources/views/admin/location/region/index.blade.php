    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            ...
            <div class="d-flex justify-content-center">
                ...
                <a href="{{ route('sett.region.create') }}"
                    ...
                    <table class="table display datatable-modal" id="p-lab-table" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-xxs">NAME CTIY</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($regions as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('sett.region.edit', $item->id) }}"
                                        ...
                                        <a class="btn btn-sm modal-effect status-col-link cancel-color-btn b-r-xs mb-1 delete-conf"
                                            title="delete" data-effect="effect-scale" data-city_id="{{ $item->id }}"
                                    ...
                                    <div class="modal fade" id="delete" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable ">
                                            <div class="modal-content b-r-s-cont border-0">
                                                ...
                                                <form action="{{ route('sett.region.destroy', $item->id) }}" method="post">
                                                    {{ method_field('delete') }}
                                                    {{ csrf_field() }}
