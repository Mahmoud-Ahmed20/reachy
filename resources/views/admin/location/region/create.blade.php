    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.countries.index') }}">Ctiys | </a>
                <a class="text-gray-300">Add Ctiy</a>
            </span>
        </div>
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-plus me-2"></i> Add new countries</h6>
            </div>

            <!-- Card Body -->
            <div class="card-body px-3">

                <form id="myforminput" method="POST" action="{{ route('sett.region.store') }}">
                    ...
                    <div class="row mb-2 ">
                        ...
                        <div class="col-12 col-md-12 mb-2">
                            ...
                            <select class="js-example-basic-single select2-no-search select2-hidden-accessible"
                                ...
                                @foreach ($ctiys as $ctiy)
                                    <option value="{{ $ctiy->id }}">{{ $ctiy->name_en }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            <label class="form-label">City name arabic<small>(required)</small></label>
                            <input name="name_ar" type="text" class="form-control @error('name_ar') is-invalid @enderror"
                                placeholder="Write the given City name arabic here.." required>
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            <label class="form-label">City name english <small>(required)</small></label>
                            <input name="name_en" type="text" class="form-control @error('name_en') is-invalid @enderror"
                                placeholder="Write the given City name english  here..">
