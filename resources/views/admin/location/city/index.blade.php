    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="card shadow mb-3 pb-2">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-globe-europe"></i> All Citys</h6>
            </div>
                    ...
                    <table class="table display datatable-modal" id="p-lab-table" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-xxs">NAME COUNTRY</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($city as $city)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('sett.city.edit', $city->id) }}"
                                        ...
                                        <a class="btn btn-sm modal-effect status-col-link cancel-color-btn b-r-xs mb-1 delete-conf"
                                            title="delete" data-effect="effect-scale" data-ctiy_id="{{ $city->id }}"
                                            data-name_ar="{{ $city->name_ar }}" data-bs-toggle="modal"
                                    ...
                                    <div class="modal fade" id="delete1" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable ">
                                            <div class="modal-content b-r-s-cont border-0">
                                                ...
                                                <form action="{{ route('sett.city.destroy', $city->id) }}" method="post">
                                                    {{ method_field('delete') }}
                                                    {{ csrf_field() }}
                                                    ...
                                                    <div class="modal-body px-4">
                                                        ...
                                                        <div class="modal-body delete-conf-input text-center py-0">
                                                            <p class="mb-0">ِAre you sure you want to delete
                                                                this
                                                                city?</p><br>
                                                            <input type="hidden" name="ctiy_id"
                                                                value="{{ $city->id }}">
                                                        </div>
                                                    </div>
...
@section('js')
    ...
    <script>
        $('.delete-conf').click(function(event) {
            var ctiy_id = $(this).data("ctiy_id");
            var name_ar = $(this).data("name_ar");
            console.log(ctiy_id);
            var modal = $('.delete-conf-input [name="ctiy_id"]')
            modal.val(ctiy_id);
            $('#name_ar').val(name_ar);
        })
    </script>
