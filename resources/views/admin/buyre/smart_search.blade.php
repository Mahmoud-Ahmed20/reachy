...
@section('title-topbar', __('Client'))
...
<div class="container-fluid px-md-2 mt-3">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <span class="mb-0">
            <a class="link-cust-text text-gray-200 fw-light" href="">{{ __('dashboard') }}
                |</a>
            <a class="link-cust-text text-gray-200 fw-light" href="">{{ __('Client') }} | </a>
            <a class="text-gray-300">{{ __('all Client') }}</a>
        </span>
    </div>
    ...
    <div class="row">
            ...
            <div class="position-relative" style="top: 0; left: 0; width: 100%; height: 100%;">
                ...
                <div class="bg-white b-r-s-cont shadow pb-4 position-sticky top-0">
                    <h6 class="mb-0 p-3 main-color-bg text-white" style="border-radius: 18px 18px 0px 0px;"><i
                            class="fas fa-filter"></i> {{ __('Client Search filter') }}</h6>

                    <form id="myform" class="mt-1" method="GET" action="{{ route('sett.show.all.client') }}">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingSpec">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        <i class="fas fa-user me-1"></i> {{ __('Client') }}
                                    </button>
                                </h2>
                                            ...
                                            @foreach ($Country as $item)
                                                <div class="form-check mb-1">
                                                    <input class="form-check-input" value="{{ $item->id }}"
                                                        type="radio" name="country_id" id="s1"
                                                        @if (request()->get('country_id') == $item->id) checked @endif>
                        ...
                        <div class="d-flex justify-content-center align-items-center mt-3">
                            <a class="text-gray-300 me-2" href="">{{ __('basic.reset') }}</a>
        ...
        <div class="col-12 col-md-9">
            ...
            <div>
                <div class="ps-0 pe-0">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-4 d-flex justify-content-between align-items-center ">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="p-3 text-self-center">
                                            ...
                                            <p class="text-with text-gray-400 text-xxs">Phone:<span
                                ...
                                <div class="col-6 col-md-4 d-flex justify-content-center align-items-center">
                                    <div class="text-center">
                                        <h6 class="text-with text-gray-400 text-s mb-2"> Active</h6>
                                        <p class="text-s fw-bold text-gray-600">
                                            @if ($item->inactive == 0)
                                ...
                                <div class="col-6 col-md-4 d-flex justify-content-center align-items-center">
                                    <div class="text-center">
                                        <h6 class="text-with text-gray-400 text-s mb-2"> Email</h6>
                                        <p class="text-s fw-bold text-gray-600">
                                            {{ $item->email }}
                                        </p>
                                    </div>
                    ...
                    <div class="d-flex mt-4 justify-content-end">
                        {{ $client->appends(request()->input('country_id'))->links() }}
                    </div>
                </div>
            ...
            <div class="d-flex mt-4 justify-content-end">
                {{-- {{ $client->appends(request()->input())->links() }} --}}
