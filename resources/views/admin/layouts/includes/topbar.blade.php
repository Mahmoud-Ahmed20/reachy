...
<nav class="topbar navbar navbar-expand navbar-light mb-2 static-top">
    ...
    <div class="pagetitle-navbar col-1 col-md-7 d-flex fullsc_topbar_hide">
        <span class="text-gray-600 d-none d-md-block text-truncate">@yield('title-topbar', 'Proxima') </span>
        <form
            ...
            <div class="p-1 bg-white rounded rounded-pill shadow-lgg position-relative">
                <div class="input-group">
                    <input id="search-eng_topbar" type="search" placeholder="What're you searching for .."
    ...
    <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1 fullsc_topbar_hide">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-bs-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <img class="me-1"
                    src="{{ URL::asset('img/dashboard/country_flags/') }}">
            ...
            <ul class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in main-color-bg px-2 py-2"
                aria-labelledby="alertsDropdown" style="width: auto !important;">
                    ...
                    <li class="p-1">
                        <a class="text-white" rel="alternate" hreflang=""
                            href=""><img
                                src="{{ URL::asset('img/dashboard/country_flags/') }}">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image me-3">
                        <img class="rounded-circle" src="data/uploads/img/undraw_profile_1.svg" alt="">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image me-3">
                        <img class="rounded-circle" src="data/uploads/img/undraw_profile_2.svg" alt="">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="dropdown-list-image me-3">
                        <img class="rounded-circle" src="data/uploads/img/undraw_profile_3.svg" alt="">
        ...
        <li class="nav-item dropdown no-arrow fullsc_topbar_hide">
            ...
            <div class="dropdown-list-profile dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item mb-2 border-bottom-0 " href="" onclick="event.preventDefault();
