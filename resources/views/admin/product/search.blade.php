    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-5">
            ...
            <span class="mb-0">
                <a class="link-cust-text text-gray-200 fw-light"
                    href="{{ route('sett.product.index') }}">{{ __('Product.dashboard') }} |</a>
                <a class="text-gray-300">{{ __('Product search') }}</a>
            </span>

            <div class="d-flex justify-content-center mt-2 mt-md-0">

                <a href="{{ route('sett.product.index') }}"
                    class=" main-color-bg btn btn-sm shadow-sm b-r-l-cont p-2 px-4 text-blue-200"><i
                        class="fas fa-box-open fa-sm text-blue-200 me-1"></i> {{ __('Product') }}</a>
        ...
        <div class="row justify-content-center position-relative">
            ...
            <div class="col-12 col-md-10 col-lg-8 col-xl-7 text-center">
                <img class="img-fluid p-md-2" width="540px"
                    src="{{ URL::asset('img/dashboard/Frozen food-rafiki.png') }}" alt="">
        ...
        @section('js')
            <script>
                ...
                var url = "{{ route('sett.search.query.product','search_query') }}";
