...
@section('title', 'New  Subscription| Proxima - Medical Management app')

@section('title-topbar', 'New Subscription')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.countries.index') }}">Subscription </a>
                <a class="text-gray-300">Add Subscription</a>
            </span>
        </div>
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-plus me-2"></i> Add new Subscription</h6>
            </div>

            <!-- Card Body -->
            <div class="card-body px-3">

                <form id="myforminput" method="POST" action="{{ route('sett.subscription.store') }}"
                            ...
                            <div class="col-12 col-md-7 mb-2">
                                <div class="mb-3">
                                    ...
                                    <input name="name_ar" type="text"
                                        ...
                                        placeholder="Write the subscription name nrabic here.." value="{{ old('name_ar') }}"
                                        autofocus required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="name_en" type="text"
                                        ...
                                        placeholder="Write the subscription name english here.." value="{{ old('name_en') }}"
                                        required>
                                </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-12 col-md-6 mb-2">
                                ...
                                <input id="password" name="slug_ar" type="text"
                                    ...
                                    placeholder="Write the subscription slug arabic here.." value="{{ old('slug_ar') }}" required>
                            ...
                            <div class="col-12 col-md-6 mb-2">
                                ...
                                <input id="text" name="limited_cost" type="text"
                                    ...
                                    placeholder="Write the limited cost here.." value="{{ old('limited_cost') }}"
                                    required>
                            ...
                            <div class="col-12 col-md-6 mb-2">
                                ...
                                <input id="text" name="amount_money" type="text"
                                    ...
                                    placeholder="Write the amount money here.." value="{{ old('amount_money') }}"
                                    required>
