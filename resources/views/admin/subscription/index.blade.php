...
@section('title', 'subscription | Proxima - Medical Management app')

@section('title-topbar', 'Subscription')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">Subscription</a>
            </span>
            ...
            <div class="d-flex justify-content-center">
                ...
                <a href="{{ route('sett.subscription.create') }}"
                    class=" main-color-bg text-white btn btn-sm shadow-sm b-r-l-cont p-2 px-4 me-1"><i
                        class="fas fa-plus fa-sm me-1"></i> New Subscription</a>
            </div>
        </div>
        ...
        <div class="card shadow mb-3 pb-2">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-globe-europe"></i> All Subscription</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
                            ...
                            @foreach ($Subuscription as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('sett.subscription.edit', $item->id) }}"
                                        ...
                                        <a class="btn btn-sm modal-effect status-col-link cancel-color-btn b-r-xs mb-1 delete-conf"
                                            ...
                                            data-subuscription_id="{{ $item->id }}" data-name_ar="{{ $item->name_ar }}"
                                    ...
                                    <div class="modal fade" id="delete1" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable ">
                                            <div class="modal-content b-r-s-cont border-0">
                                                ...
                                                <form action="{{ route('sett.subscription.destroy', $item->id) }}"
                                                    method="post">
                                                    {{ method_field('delete') }}
                                                    {{ csrf_field() }}
                                                    ...
                                                    <div class="modal-body px-4">
                                                        ...
                                                        <div class="modal-body delete-conf-input text-center py-0">
                                                            <p class="mb-0">ِAre you sure you want to delete
                                                                this
                                                                city?</p><br>
                                                            <input type="hidden" name="subuscription_id"
                                                                value="{{ $item->id }}">
                                                        </div>
                                                    </div>
...
@section('js')
    ...
    <script>
        $('.delete-conf').click(function(event) {
            var subuscription_id = $(this).data("subuscription_id");
            var name_ar = $(this).data("name_ar");
            console.log(subuscription_id);
            var modal = $('.delete-conf-input [name="subuscription_id"]')
            modal.val(subuscription_id);
            $('#name_ar').val(name_ar);
        })
    </script>
