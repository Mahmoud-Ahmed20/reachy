                            ...
                            <div class="d-flex mb-3 " style="display: flex;margin: 3px;">
                                <form action = "{{ route('sett.update_status_order' , $order_item->id) }}" method="POST">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-default btn-primary mt-3">Send
                                        </button>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="bg-white b-r-s-cont mb-2 px-3 py-2 mb-3">
                                ...
                                <div class="col-6 col-md-4 d-flex justify-content-center align-items-center">
                                    ...
                                    <form action = "{{ route('sett.update_status' , $order_item->id) }}" method="POST">
                                        ...
                                        <option @if ($order_item->status == 3)
                                            selected
                                        @endif value="3">delivered  to the warehouse</option>
                            ...
                            <div class="row justify-content-center order_steps">
                                ...
                                <div class="d-flex justify-content-start">
                                    ...
                                    <div>
                                        <h6 class="d-flex m-0 text-s me-2 align-items-center mb-0">
                                            <p class="mb-0 me-2 fw-bold">Processing</p>
                                ...
                                <div class="col align-self-center text-start mt-2">
                                    <div class="d-flex justify-content-start">
                                        <p class="rounded-circle text-gray-700 border m-1 size_30 d-flex justify-content-center align-items-center">
                                            2
                                        </p>
                                    </div>
                                    <div>
                                        <h6 class="d-flex m-0 text-s text-gray-700 align-items-center">
                                            <p class="mb-0 me-2 fw-bold">Confirmed</p>
                                            <hr class="float-end">
                                        </h6>
                                    </div>
                                </div>
                                ...
                                <div class="col align-self-center text-start mt-2">
                                    <div class="d-flex justify-content-start">
                                        <p class="rounded-circle border text-gray-200 m-1 size_30 d-flex justify-content-center align-items-center">
                                            3
                                        </p>
                                    </div>
                                    <div>
                                        <h6 class="d-flex m-0 text-s text-gray-200 align-items-center">
                                            <p class="mb-0 me-2 fw-light">Delivered to the warehouse</p>
                                            <hr class="float-end">
                                        </h6>
                                        <p class="text-gray-300 text-xxs mb-0">
                                    </div>
                            ...
                            <div class="row justify-content-center order_steps">
                                ...
                                <div class="col align-self-center text-start mt-2">
                                    <div class="d-flex justify-content-start">
                                        <div class="rounded-circle border m-1 size_30 p-1"><i class="fa-solid fa-check fs-5"></i>
                                        </div>
                                    </div>
                                    <div>
                                        <h6 class="d-flex m-0 text-s text-gray-700 align-items-center">
                                        ...
                                        <p class="text-gray-300 text-xxs mb-0">
                                            {{ date('d M Y', strtotime($order_item->seller_confirmation_date)) }}</p>
                                    </div>
                                </div>

                                <div class="col align-self-center text-start mt-2">
                                    <div class="d-flex justify-content-start">
                                        <p class="rounded-circle border text-gray-700 m-1 size_30 d-flex justify-content-center align-items-center">
                                            3
                                        </p>
                                    </div>
                                    <div>
                                        <h6 class="d-flex m-0 text-s text-gray-700 align-items-center">
                                            <p class="mb-0 me-2 fw-bold">Delivered to the warehouse</p>
                                            <hr class="float-end">
                                        </h6>
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-center order_steps">
                                <div class="col align-self-center mt-2">
                                    <div class="d-flex justify-content-start">
                                        <div class="rounded-circle border m-1 size_30 p-1">
                                ...
                                <div class="col align-self-center text-start mt-2">
                                    ...
                                    <div>
                                        <h6 class="d-flex m-0 text-s text-gray-700 align-items-center">
                                            <p class="mb-0 me-2 fw-bold">Purchased</p>
                                            <hr class="float-end">
                                        </h6>
                                        <p class="text-gray-300 text-xxs mb-0">
                                            {{ date('d M Y', strtotime($order_item->purchased_date)) }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col align-self-center text-start mt-2">
                                    ...
                                    <div>
                                        <h6 class="d-flex m-0 text-s text-gray-700 align-items-center">
                                            <p class="mb-0 me-2 fw-bold">Seller Warehouse</p>
                                            <hr class="float-end">
                                        </h6>
                                    </div>
                                </div>
                                ...
                                <div class="col align-self-center text-start mt-2">
                                    ...
                                    <div>
                                        <h6 class="d-flex m-0 text-s text-gray-200 align-items-center">
                                            <p class="mb-0 me-2 fw-light">Egypt Warehouse</p>
                                            <hr class="float-end">
                                        </h6>
                                    </div>
                                </div>
                                ...
                                <div class="col align-self-center text-start mt-2">
                                    ...
                                    <div>
                                        <h6 class="d-flex m-0 text-s text-gray-200 align-items-center">
                                            <p class="mb-0 me-2 fw-light">Out for delivery</p>
                                            <hr class="float-end">
                                        </h6>
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-center order_steps">
                                ...
                                <div class="col align-self-center text-start mt-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-300 text-xxs mb-0">
                                            {{ date('d M Y', strtotime($order_item->seller_warehouse_date)) }}</p>
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col align-self-center text-start mt-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-300 text-xxs mb-0">
                                            {{ date('d M Y', strtotime($order_item->egypt_warehouse_date)) }}</p>
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col align-self-center text-start mt-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-300 text-xxs mb-0">
                                            {{ date('d M Y', strtotime($order_item->out_for_delivery_date)) }}</p>
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col align-self-center text-start mt-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-300 text-xxs mb-0">
                                            {{ date('d M Y', strtotime($item->egypt_warehouse_date)) }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col align-self-center text-start mt-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-300 text-xxs mb-0">
                                            {{ date('d M Y', strtotime($order_item->delivered_date)) }}</p>
                                    </div>
                                </div>
                            </div>
                            @endif
