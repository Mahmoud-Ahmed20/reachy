@extends('admin/layouts.normmaster')

@section('title', 'Login | Proxima - Medical Management app')
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    ...
                                    <h1 class="h4 text-gray-900 mb-2">welcome huntoffer</h1>
                                </div>
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group mb-1">
                                        <label for="password"
                                            class="col-md-4 col-form-label text-md-right">{{ __('patientappo.phone number') }}</label>
                                    ...
                                    <div class="form-group">
                                        <label for="password"
                                            class="col-md-4 col-form-label text-md-right">{{ __('patientappo.password') }}</label>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox small">
                                            ...
                                            <label class="custom-control-label-user"
                                                for="remember">{{ __('basic.remember me') }}</label>
                                        </div>
                                    </div>
