    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">Add Seller</a>
            </span>
        </div>
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-plus me-2"></i> Add new seller</h6>
            </div>

            <!-- Card Body -->
            <div class="card-body px-3">

                <form id="myforminput" method="POST" action="{{ route('sett.store.seller') }}" enctype= multipart/form-data>
                    ...
                    <div class="row mb-2 ">
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            ...
                            <input name="first_name" type="text" value="{{ old('first_name') }}" class="form-control @error('first_name') is-invalid @enderror"
                                placeholder="Write the First name here.." required>
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            ...
                            <input name="second_name" type="text" value="{{ old('second_name') }}" class="form-control @error('second_name') is-invalid @enderror"
                                placeholder="Write the Second name here.." required>
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            ...
                            <input name="commercial_register" type="file" class="form-control @error('commercial_register') is-invalid @enderror"
                                placeholder="Add the Commercial Register here.." required>
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            ...
                            <input name="tax_register" type="file" class="form-control @error('tax_register') is-invalid @enderror"
                                placeholder="Add the Tax Register here.." required>
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            ...
                            <input name="user" type="text" class="form-control @error('user') is-invalid @enderror"
                                placeholder="Write the Url here.." required>
