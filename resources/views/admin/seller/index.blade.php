    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">Seller</a>
            </span>

            <div class="d-flex justify-content-center">


                <a href="{{ route('sett.create.seller') }}"
                    class=" main-color-bg text-white btn btn-sm shadow-sm b-r-l-cont p-2 px-4 me-1"><i
                        class="fas fa-plus fa-sm me-1"></i> New Seller</a>
            </div>
        </div>
        ...
        <div class="card shadow mb-3 pb-2">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-users me-2"></i> All Seller</h6>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table display datatable-modal" id="p-lab-table" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th class="text-xxs text-center">Avatar</th>
                                ...
                                <th class="text-xxs text-center">Commercial Register</th>
                                <th class="text-xxs text-center">Tax Register</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a class="d-flex align-items-center"
                                            href="{{ route('sett.show.seller',$item->id) }}">
                                    ...
                                    <td class="text-center">
                                      <div class="">
                                              <img class="rounded-circle avatar-small me-2"
                                              src="{{ URL::asset('img/useravatar/' . $item->commercial_register) }}">
                                          <p class="mb-0 text-xs text-gray-300"></p>
                                      </div>
                                    </td>
                                    <td class="text-center">
                                      <div class="">
                                              <img class="rounded-circle avatar-small me-2"
                                              src="{{ URL::asset('img/useravatar/' . $item->tax_register) }}">
                                          <p class="mb-0 text-xs text-gray-300"></p>
                                      </div>
                                    </td>

                                    <td class="text-center">
                                        <a href="{{route('sett.edit_seller' ,$item->id)}}"
                                    ...
                                    <div class="modal fade" id="delete1" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable ">
                                            <div class="modal-content b-r-s-cont border-0">
                                                ...
                                                <form action="{{ route('sett.destroy.seller', $item->id) }}" method="post">
                                                      {{ method_field('delete') }}
                                                      {{ csrf_field() }}
