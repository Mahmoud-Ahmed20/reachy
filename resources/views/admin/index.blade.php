...
@section('title', 'Workers | Proxima - Medical Management app')

@section('title-topbar', 'Workers')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">Admins</a>
            </span>
            ...
            <div class="d-flex justify-content-center">
                ...
                <a href="{{ route('sett.admin.create') }}"
                    class=" main-color-bg text-white btn btn-sm shadow-sm b-r-l-cont p-2 px-4 me-1"><i
                        class="fas fa-plus fa-sm me-1"></i> New Admin</a>
            </div>
        </div>
        ...
        <div class="card shadow mb-3 pb-2">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-users me-2"></i> All Admins</h6>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-sm modal-effect status-col-link cancel-color-btn b-r-xs mb-1 delete-conf"
                                            title="delete" data-effect="effect-scale" data-user_id="{{ $iteam->id }}"
                                            data-username="{{ $iteam->first_name }}" data-bs-toggle="modal"
                                            data-bs-target="#delete1"><i class="fas fa-trash"></i> Delete
                                        </a>
                                        {{-- <a href="{{ route('sett.hr_attendance', $iteam->id) }}"
