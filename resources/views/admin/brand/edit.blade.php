...
@section('title', 'Edit  brand | Proxima - Medical Management app')

@section('title-topbar', 'Edit brand')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-plus me-2"></i> Edit brand</h6>
            </div>

            <!-- Card Body -->
            <div class="card-body px-3">

                <form id="myforminput" method="POST" action="{{ route('sett.brand.update',$brand->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-1">
                                <div class="col-12 col-md-5 align-self-center mb-2">
                                    ...
                                    <div class="avatar-update-container">
                                        <div class="picture">
                                        <img src="{{ URL::asset('img/brands/'. $brand->logo ) }}"
                                ...
                                <div class="col-12 col-md-7 mb-2">
                                    <div class="mb-3">
                                        ...
                                        <input name="name_ar" type="text"
                                            ...
                                            placeholder="Write the barnd name nrabic here.." value="{{$brand->name_ar}}"  autofocus required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="name_en" type="text"
                                            ...
                                            placeholder="Write the barnd name english here.." value="{{$brand->name_en}}" " required>
                                    </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-12 col-md-6 mb-2">
                                    ...
                                    <input id="password" name="slug_ar" type="text"
                                        ...
                                        placeholder="Write the barnd slug nrabic here.." value="{{$brand->slug_ar}}" required>
