    ...
    <div class="container vh-100 d-flex align-items-center justify-content-center">
        <div class="row justify-content-center ">
            <div class="col-12 col-md-8 text-center">
                <img class="position-relative" width="100px" src="{{ URL::asset('img/dashboard/system/loader.svg') }}"
                ...
                <h4 class="text-gray-300 fw-light">You are not supposed to be here</h4>
            </div>
        </div>
    </div>
