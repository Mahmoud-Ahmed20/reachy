...
@section('title', 'Examination | Proxima - Medical Management app')

@section('title-topbar', 'Examination')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">{{ __('patientappo.medicines controll') }}</a>
            </span>

            <div class="d-flex justify-content-center">
                <a href="{{ route('sett.examinationcat.create') }}"
        ...
        <div class="card shadow mb-3 pb-2">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i
                        class="fas fa-x-ray me-2"></i>{{ __('patientappo.medicines controll') }}</h6>
                            ...
                            @foreach ($examination as $iteam)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('sett.examinationcat.edit', $iteam->id) }}"
