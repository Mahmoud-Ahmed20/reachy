...
@section('title', 'Cancel reason | Proxima - Medical Management app')

@section('title-topbar', 'Cancel reason')
    ...
    <div class="container-fluid px-0 px-md-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.cancelreasoncat.index') }}">Cancel
                    reason |
                </a>
                <a class="text-gray-300">{{ __('patientappo.cancel reason') }}</a>
            </span>
        </div>
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-body px-4 px-md-5">
                ...
                <form id="myform" method="POST" action="{{ route('sett.cancelreasoncat.store') }}">
                        ...
                        <div class="col-12 col-md-10 col-lg-7">
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    <label class="form-label">{{ __('basic.reason') }}
                                        <small>({{ __('basic.required') }})</small></label>
                                    <input name="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                        placeholder="Reason Name.." required>
