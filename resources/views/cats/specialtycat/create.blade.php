...
@section('title', 'New Specialty | Proxima - Medical Management app')

@section('title-topbar', 'New Specialty')
    ...
    <div class="container-fluid px-0 px-md-2 mt-3">
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-stethoscope me-1"></i> New Specialty</h6>
            </div>
            ...
            <div class="card-body px-4 px-md-5">
                ...
                <form id="myform" method="POST" action="{{ route('sett.specialtycat.store') }}">
