...
@section('title', 'New Medicine | Proxima - Medical Management app')

@section('title-topbar', 'New Medicine')
    ...
    <div class="container-fluid px-0 px-md-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">{{ __('patientappo.new medicines') }}</a>
            </span>
        </div>
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-capsules me-1"></i>
                    {{ __('patientappo.new medicines') }}</h6>
            </div>
            ...
            <div class="card-body px-4 px-md-5">
                ...
                <form id="myform" method="POST" action="{{ route('sett.medicinecat.store') }}">
