...
@section('title', 'Medicines | Proxima - Medical Management app')

@section('title-topbar', 'Medicines')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">{{ __('patientappo.resources controll') }}</a>
            </span>

            <div class="d-flex justify-content-center">
                <a href="{{ route('sett.medicinecat.create') }}"
        ...
        <div class="card shadow mb-3 pb-2">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-capsules me-2"></i>Medicines Controll</h6>
                            ...
                            @foreach ($medicine as $iteam)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('sett.medicinecat.edit', $iteam->id) }}"
