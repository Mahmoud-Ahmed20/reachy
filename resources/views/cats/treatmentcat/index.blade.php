...
@section('title', 'Treatment | Proxima - Medical Management app')

@section('title-topbar', 'Treatment')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">{{ __('patientappo.treatment controll') }}</a>
            </span>

            <div class="d-flex justify-content-center">
                <a href="{{ route('sett.treatmentcat.create') }}"
        ...
        <div class="card shadow mb-3 pb-2">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i
                        class="fas fa-capsules me-2"></i>{{ __('patientappo.treatment controll') }}</h6>
                            ...
                            @foreach ($treatment as $iteam)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('sett.treatmentcat.edit', $iteam->id) }}"
