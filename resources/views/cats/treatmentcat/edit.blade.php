...
@section('title', 'Edit Treatment | Proxima - Medical Management app')

@section('title-topbar', 'Edit Treatment')
    ...
    <div class="container-fluid px-0 px-md-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="link-cust-text text-gray-200 fw-light"
                    href="{{ route('sett.treatmentcat.index') }}">{{ __('basic.treatments') }} |
                </a>
                <a class="text-gray-300">{{ __('patientappo.edit treatment') }}</a>
            </span>
        </div>
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i
                        class="fas fa-capsules me-1"></i>{{ __('patientappo.edit treatment') }}</h6>
            </div>
            ...
            <div class="card-body px-4 px-md-5">
                ...
                <form id="myform" method="POST" action="{{ route('sett.treatmentcat.update', $treatment->id) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input name="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                        placeholder="Branch Name.." value="{{ $treatment->name }}" required>
