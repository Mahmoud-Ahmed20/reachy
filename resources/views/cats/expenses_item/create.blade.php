...
@section('title-topbar', 'New Expenses item')
    ...
    <div class="container-fluid px-0 px-md-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="link-cust-text text-gray-200 fw-light"
                    href="{{ route('sett.expenses_item.index') }}">{{ __('basic.expenses') }} | </a>
                <a class="text-gray-300">{{ __('patientappo.new expenses item') }}</a>
            </span>
        </div>
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-x-ray me-1"></i> {{ __('patientappo.new expenses') }}
                </h6>
            </div>
            ...
            <div class="card-body px-4 px-md-5">
                ...
                <form id="myform" method="POST" action="{{ route('sett.expenses_item.store') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input name="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                        placeholder="Expneses Name ..." required>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input name="price" type="number"
                                        ...
                                        placeholder="Expenses Price ..." required>
