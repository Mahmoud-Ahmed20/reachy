    ...
    <div class="container-fluid px-0 px-md-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.askforcat.index') }}">Ask for |
                </a>
                <a class="text-gray-300">{{ __('patientappo.ask for') }}</a>
            </span>
        </div>
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-body px-4 px-md-5">
                ...
                <form id="myform" method="POST" action="{{ route('sett.askforcat.store') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input name="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                        placeholder="Ask for Name.." required>
