...
@section('title', 'New Debtor | Proxima - Medical Management app')

@section('title-topbar', 'New Debtor')
    ...
    <div class="container-fluid px-0 px-md-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="link-cust-text text-gray-200 fw-light" href="{{ route('sett.debtorcat.index') }}">Debtor | </a>
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-map-marker-alt me-1"></i> New Debtor</h6>
            </div>
            ...
            <div class="card-body px-4 px-md-5">
                ...
                <form id="myform" method="POST" action="{{ route('sett.debtorcat.store') }}"
                                ...
                                <div class="col-12 col-md-7 mb-2">
                                    <div class="mb-3">
                                        ...
                                        <input name="first_name" type="text"
                                            ...
                                            placeholder="Ahmed212 ..." autofocus required value="{{ old('first_name') }}">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="second_name" type="text"
                                            ...
                                            placeholder="Ibrahm ..." value="{{ old('second_name') }}">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="company_name" type="text"
                                            ...
                                            placeholder="Lamar Company ..." value="{{ old('company_name') }}">
                                    </div>
