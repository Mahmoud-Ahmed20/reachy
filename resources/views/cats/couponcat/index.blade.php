...
@section('title', 'Coupons | Proxima - Medical Management app')

@section('title-topbar', 'Coupons')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">Coupons Controll</a>
            </span>

            <div class="d-flex justify-content-center">
                <a href="{{ route('sett.couponcat.create') }}"
        ...
        <div class="card shadow mb-3 pb-2">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-money-check-alt me-2"></i>Coupons Controll</h6>
                    ...
                    <table class="table display datatable-modal" id="p-lab-table" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-xxs text-center">VALUE</th>
                                <th class="text-xxs text-center">PERCENT</th>
                                <th class="text-xxs text-center">STATUS</th>
                                <th class="text-xxs">CREATED AT</th>
                                <th class="text-xxs text-center">HANDLE</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($coupon as $iteam)
                                <tr>
                                    ...
                                    <td>
                                        {{ date('d M Y', strtotime($iteam->created_at)) }}
                                    </td>

                                    <td class="text-center">
                                        <a href="{{ route('sett.couponcat.edit', $iteam->id) }}"
