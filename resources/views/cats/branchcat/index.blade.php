...
@section('title', 'Branches | Proxima - Medical Management app')

@section('title-topbar', 'Branches')
    ...
    <div class="container-fluid px-2 mt-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-3">
            <span class="mb-0">
                ...
                <a class="text-gray-300">Branches Controll</a>
            </span>

            <div class="d-flex justify-content-center">
                <a href="{{ route('sett.branchcat.create') }}"
        ...
        <div class="card shadow mb-3 pb-2">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-map-marker-alt me-2"></i>Branches Controll</h6>
                    ...
                    <table class="table display datatable-modal" id="p-lab-table" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-xxs">Latitude</th>
                                <th class="text-xxs">Longitude</th>
                            ...
                            @foreach ($branch as $iteam)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('sett.branchcat.edit', $iteam->id) }}"
