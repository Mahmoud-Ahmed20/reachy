...
@section('title', 'Edit Branch | Proxima - Medical Management app')

@section('title-topbar', 'Edit Branch')
    ...
    <div class="container-fluid px-0 px-md-2 mt-3">
        ...
        <div class="card card-input shadow mb-3 pb-3">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 fw-bold text-gray-500"><i class="fas fa-map-marker-alt me-1"></i> Edit Branch</h6>
            </div>
            ...
            <div class="card-body px-4 px-md-5">
                ...
                <form id="myform" method="POST" action="{{ route('sett.branchcat.update', $branch->id) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input name="name" type="text"
                                        class="form-control @error('name') is-invalid @enderror" placeholder="Branch Name.."
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input name="address" type="text"
                                        ...
                                        placeholder="Branch Address.." value="{{ $branch->address }}" required>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input name="latitude" type="text"
                                        ...
                                        placeholder="Branch latitude.." value="{{ $branch->latitude }}" required>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input name="longitude" type="text"
                                        ...
                                        placeholder="Branch longitude.." value="{{ $branch->longitude }}" required>
